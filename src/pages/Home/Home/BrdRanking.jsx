...
function BrdRanking() {
  return (
    <div
      className="cmgrid_full_box cmgrid_brd_ranking ty_border"
      data-page-set-id="121"
      data-has-next="false"
      data-react-tarea-cd="100000000149_121_301"
      data-observable-unit="true"
    >
      <div className="cmgrid_brd_wrap open">
        <div className="cmgrid_brd_num v2">
          <div
            className="cmgrid_brd_rank_wrap"
            data-react-unit-type="text"
            data-react-unit-text='[{"type":"text","value":"접음/펼침"}, {"type":"brand","value":"gucci"}]'
          >
            <button
              type="button"
              className="cmitem_btn ranking_btn_drop clickable"
            ...
            >
              ...
              <div className="cmitem_keyword_tx">
                <div className="cmitem_keyword_tx_tit">
                  ...
                  <span className="cmitem_keyword_rankinfo cmitem_keyword_ranksame">
                    <span className="blind">순위 동일</span>
                  </span>
                </div>
                <span className="cmitem_keyword_ranktx_sub" />
              </div>
            </button>
          </div>
          ...
          <div className="cmitem_brd_btn_wrap">
            ...
            >
              ...
              <input type="hidden" name="attnTgtIdnfNo1" value="gucci" />
              <input type="hidden" name="attnTgtIdnfNo2" value="" />
              <input type="hidden" name="notiTitle" value="" />
        ...
        <div className="cmgrid_brd_ranking_unit" style={{ display: 'none' }}>
          <div className="cmhorizontal_scrollitem cmhorizontal_brd_ranking cmhorizontal_scrollitem_sd has_cmitem_helper">
            <div className="cmhorizontal_scroll">
              <div className="cmitem_grid">
                <ul className="cmitem_grid_lst mnsditem_ty_thmb">
                  <li
                    className="cmitem_grid_item ty_space"
                    data-observable-item="true"
                    data-react-unit-type="item"
                    data-react-unit-id="1000338899298"
                          ...
                          <div className="mnsditem_btn_like">
                            <span className="cmlike _js_cmlike interestIt">
                              ...
                              <input
                                type="hidden"
                                name="notiTitle"
                                value="[구찌 홀스빗 1955] 미니백"
                              />
                              <input
                                type="hidden"
                                name="notiImgPath"
                                value="//sitem.ssgcdn.com/98/92/89/item/1000338899298_i1_500.jpg"
                              />
                              <input type="hidden" name="checked" value="N" />
                              <input
                                type="hidden"
                  ...
                  <li
                    ...
                    data-observable-item="true"
                    data-react-unit-type="item"
                    data-react-unit-id="1000050294029"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="mnsditem_thmb">
                          <a
                            href="https://m-shinsegaemall.ssg.com/special/itemView.ssg?itemId=1000050294029&amp;siteNo=6004&amp;salestrNo=6005&amp;itemSsgCollectYn=N"
                            className="mnsditem_thmb_link clickable"
                            data-info="1000050294029"
                            data-index="0"
                            data-position="view"
                          ...
                          <div className="mnsditem_thmb_ctrl">
                            <a
                              href="https://m.ssg.com/search/image/main.ssg?searchType=img&amp;itemId=1000050294029&amp;src_area=ssglens"
                              className="mnsditem_btn_lens clickable"
                              data-info="1000050294029"
                          ...
                          <div className="mnsditem_btn_like">
                            <span className="cmlike _js_cmlike interestIt">
                              ...
                              <input
                                type="hidden"
                                name="notiTitle"
                                value="[GG 마몽] 마틀라세 레더 수퍼 미니백"
                              />
                              <input
                                type="hidden"
                                name="notiImgPath"
                                value="//sitem.ssgcdn.com/29/40/29/item/1000050294029_i1_500.jpg"
                              />
                              <input type="hidden" name="checked" value="N" />
                              <input
                                type="hidden"
                  ...
                  <li
                    ...
                    data-observable-item="true"
                    data-react-unit-type="item"
                    data-react-unit-id="1000441903945"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div className="mnsditem_thmb">
                          <a
                            href="https://m-shinsegaemall.ssg.com/special/itemView.ssg?itemId=1000441903945&amp;siteNo=6004&amp;salestrNo=6005&amp;itemSsgCollectYn=N"
                            className="mnsditem_thmb_link clickable"
                            data-info="1000441903945"
                            data-index="0"
                            data-position="view"
                            data-react-tarea-dtl-cd="t00001"
                          >
                          ...
                          <div className="mnsditem_btn_like">
                            <span className="cmlike _js_cmlike interestIt">
                              ...
                              <input
                                type="hidden"
                                name="notiTitle"
                                value="[GG 마몽] 탑 핸들 미니백"
                              />
                              <input
                                type="hidden"
                                name="notiImgPath"
                                value="//sitem.ssgcdn.com/45/39/90/item/1000441903945_i1_500.jpg"
                              />
                              <input type="hidden" name="checked" value="N" />
                              <input
                                type="hidden"
              ...
              <div
                className="cmhorizontal_btns"
                data-react-unit-type="text"
                data-react-unit-text='[{"type":"text","value":"더보기"}, {"type":"brand","value":"gucci"}]'
              >
                <a
                  href="https://m-shinsegaemall.ssg.com/special/gucci/main.ssg?tarea=store6004index"
                  className="cmhorizontal_more clickable"
                  data-react-tarea-dtl-cd="t00060"
                >
                  상품 더보기
                </a>
          ...
          <div
            className="cmitem_more"
            data-react-unit-type="text"
            data-react-unit-text='[{"type":"text","value":"바로가기"}, {"type":"brand","value":"gucci"}]'
          >
            <a
              href="https://m-shinsegaemall.ssg.com/special/gucci/main.ssg?tarea=store6004index"
              className="cmitem_more_link clickable"
              data-react-tarea-dtl-cd="t00060"
            >
              브랜드매장 바로가기
              <span className="cmitem_more_arrow" />
            </a>
          </div>
        </div>
      </div>
