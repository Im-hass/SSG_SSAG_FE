        ...
        <>
           <div className={`btm_bgn_in dps2 ${goBuyBtn}`}>
                <ul className="btm_bgn_bx" id="dps2_gift" style={{ display: "none" }}>
                  <li>
                    <a href="javascript:;" onClick="fn_giftService('10', '12');return false;"
                      className="mndtl_btn type01 clickable" target="_parent">
                ...
                <ul className="btm_bgn_bx" id="dps2_buy">
                  <li>
                    <a href="javascript:;" onClick="fn_SaveCart(this, 'cart', 'floating');return false;"
                      className="mndtl_btn type02 clickable" target="_parent">
                      <span className="btn_tx">장바구니</span>
                    </a>
                  </li>
                  <li>
                    <Link to='/buyPage' className="mndtl_btn type01 clickable" target="_parent"
                      onClick={openBuyBtn}>
