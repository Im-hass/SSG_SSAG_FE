        ...
        <>
         <div className={`btm_bgn_in dps1 ${buyBtn}`}>
                <ul className="btm_bgn_bx type_other1">
                  ...
                  <li>
                    <a href="javascript:;"
                      className="mndtl_btn type05 line type_gift _js_mndtl_opt_toggle_btn clickable" target="_parent">
                  ...
                  <li>
                    <a href="javascript:;" className="mndtl_btn type01 line _js_mndtl_opt_toggle_btn clickable"
                      target="_parent" onClick={openBuyBtn}>
